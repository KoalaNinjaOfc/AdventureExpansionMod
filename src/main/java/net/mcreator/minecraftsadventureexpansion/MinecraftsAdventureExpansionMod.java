 ...
 *
 */
package net.mcreator.minecraftsadventureexpansion;
...
@Mod("minecrafts_adventure_expansion")
public class MinecraftsAdventureExpansionMod {
	public static final Logger LOGGER = LogManager.getLogger(MinecraftsAdventureExpansionMod.class);
	public static final String MODID = "minecrafts_adventure_expansion";
