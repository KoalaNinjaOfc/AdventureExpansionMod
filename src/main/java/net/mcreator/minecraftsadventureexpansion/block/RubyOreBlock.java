...
public class RubyOreBlock extends MinecraftsAdventureExpansionModElements.ModElement {
	@ObjectHolder("minecrafts_adventure_expansion:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(MinecraftsAdventureExpansionModElements instance) {
		super(instance, 3);
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(MinecraftsAdventureExpansionModTabItemGroup.tab))
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("minecrafts_adventure_expansion:ruby_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecrafts_adventure_expansion:ruby_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
