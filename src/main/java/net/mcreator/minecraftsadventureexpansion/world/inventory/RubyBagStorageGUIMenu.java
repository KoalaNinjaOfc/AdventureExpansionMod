...
package net.mcreator.minecraftsadventureexpansion.world.inventory;
...
import net.mcreator.minecraftsadventureexpansion.init.MinecraftsAdventureExpansionModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class RubyBagStorageGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RubyBagStorageGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinecraftsAdventureExpansionModMenus.RUBY_BAG_STORAGE_GUI, id);
