...
public class RubyOreFeature extends OreFeature {
	public static final RubyOreFeature FEATURE = (RubyOreFeature) new RubyOreFeature().setRegistryName("minecrafts_adventure_expansion:ruby_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, MinecraftsAdventureExpansionModBlocks.RUBY_ORE.defaultBlockState(), 4))
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<RubyOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("minecrafts_adventure_expansion:ruby_ore_match"), () -> codec);
