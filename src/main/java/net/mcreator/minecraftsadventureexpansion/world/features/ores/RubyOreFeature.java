...
public class RubyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("minecrafts_adventure_expansion:ruby_ore", FEATURE,
				new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, MinecraftsAdventureExpansionModBlocks.RUBY_ORE.get().defaultBlockState(), 4));
		PLACED_FEATURE = PlacementUtils.register("minecrafts_adventure_expansion:ruby_ore", CONFIGURED_FEATURE,
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("minecrafts_adventure_expansion:ruby_ore_match"), CUSTOM_MATCH);
		}
