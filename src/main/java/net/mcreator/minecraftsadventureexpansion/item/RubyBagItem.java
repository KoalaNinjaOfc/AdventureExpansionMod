...
import net.mcreator.minecraftsadventureexpansion.gui.RubyBagStorageGUIGuiWindow;
import net.mcreator.minecraftsadventureexpansion.gui.RubyBagStorageGUIGui;
...
public class RubyBagItem extends MinecraftsAdventureExpansionModElements.ModElement {
	@ObjectHolder("minecrafts_adventure_expansion:ruby_bag")
	public static final Item block = null;
	public RubyBagItem(MinecraftsAdventureExpansionModElements instance) {
		super(instance, 5);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof RubyBagStorageGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MinecraftsAdventureExpansionModTabItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("ruby_bag");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Ruby Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new RubyBagStorageGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
